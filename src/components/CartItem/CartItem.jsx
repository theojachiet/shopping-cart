                ...
                <div className={styles.infoText}>
                    ...
                    <div className={styles.controls}>
                        <div className={styles.quantityControl}>
                            <button className={styles.cartButton} onClick={() => handleDecreaseQuantity(item.id, item.quantity)}>-</button>
                            <input type="text" value={item.quantity} onChange={(e) => handleChangeQuantity(item.id, e.target.value)} />
                            <button className={styles.cartButton} onClick={() => handleIncreaseQuantity(item.id, item.quantity)}>+</button>
                        </div>
